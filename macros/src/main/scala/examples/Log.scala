...
//this code is intended for demo purpose(and for me to remember what can be done).Pls look at TODOs for possible simplifications
object LogCommon {
  ...
  private def getIsEnabledAndLog(self: Tree, methodName: String): (Defn.Val, (Term, Term)) = {
    ...
    //TODO: Supporting different log levels is probably not necessary
  ...
  """
    //TODO: the following feature is probably not necessary
